...
class ProposalLayer(caffe.Layer):
    ...
    def forward(self, bottom, top):
        ...
        min_size      = float(cfg[cfg_key].RPN_MIN_SIZE)
...
def _filter_boxes(boxes, min_size):
    ...
    # # ---- test ----
    # ws_nan = np.isnan(ws)
    # ws_nan_idx = np.where(ws_nan == True)[0]
    # hs_nan = np.isnan(hs)
    # hs_nan_idx = np.where(hs_nan == True)[0]
    # print '--- ws_nan_idx: --- '
    # print ws_nan_idx
    # print '--- hs_nan_idx: ---'
    # print hs_nan_idx
    ...
    # ws_inf = np.isinf(ws)
    # ws_inf_idx = np.where(ws_inf == True)[0]
    # hs_inf = np.isinf(hs)
    # hs_inf_idx = np.where(hs_inf == True)[0]
    # print '--- ws_inf_idx: --- '
    # print ws_inf_idx
    # print '--- hs_inf_idx: ---'
    # print hs_inf_idx
